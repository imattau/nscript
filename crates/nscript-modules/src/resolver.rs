...
const BUILTINS: &[(&str, &str)] = &[
    ...
    (
        "concord01",
        include_str!("../../../modules/std/concord01/0.1.0.nsm"),
    ),
    (
        "concord02",
        include_str!("../../../modules/std/concord02/0.1.0.nsm"),
    ),
    (
        "concord04",
        include_str!("../../../modules/std/concord04/0.1.0.nsm"),
    ),
    (
        "concord05",
        include_str!("../../../modules/std/concord05/0.1.0.nsm"),
    ),
    (
        "concord06",
    ...
    (
        "ncc00",
        include_str!("../../../modules/std/ncc00/0.1.0.nsm"),
    ),
    (
        "ncc02",
        include_str!("../../../modules/std/ncc02/0.1.0.nsm"),
    ),
    (
        "ncc07",
    ...
    (
        "nip42",
        include_str!("../../../modules/std/nip42/0.1.0.nsm"),
    ),
    (
        "nip45",
        include_str!("../../../modules/std/nip45/0.1.0.nsm"),
    ),
    (
        "nip50",
        include_str!("../../../modules/std/nip50/0.1.0.nsm"),
    ),
    (
        "nip53",
        include_str!("../../../modules/std/nip53/0.1.0.nsm"),
    ),
    (
        "nip56",
        include_str!("../../../modules/std/nip56/0.1.0.nsm"),
    ),
    (
        "nip58",
        include_str!("../../../modules/std/nip58/0.1.0.nsm"),
    ),
    (
        "nip68",
        include_str!("../../../modules/std/nip68/0.1.0.nsm"),
    ),
    (
        "nip71",
        include_str!("../../../modules/std/nip71/0.1.0.nsm"),
    ),
    (
        "nip77",
        include_str!("../../../modules/std/nip77/0.1.0.nsm"),
    ),
    (
        "nip84",
        include_str!("../../../modules/std/nip84/0.1.0.nsm"),
    ),
    (
        "nip85",
        include_str!("../../../modules/std/nip85/0.1.0.nsm"),
    ),
    (
        "nip86",
        include_str!("../../../modules/std/nip86/0.1.0.nsm"),
    ),
    (
        "nip89",
        include_str!("../../../modules/std/nip89/0.1.0.nsm"),
    ),
    (
        "nip94",
        include_str!("../../../modules/std/nip94/0.1.0.nsm"),
    ),
    (
        "nipb7",
        include_str!("../../../modules/std/nipb7/0.1.0.nsm"),
    ),
    (
        "nip98",
        include_str!("../../../modules/std/nip98/0.1.0.nsm"),
    ),
    (
        "nip19",
    ...
    (
        "nip47",
        include_str!("../../../modules/std/nip47/0.1.0.nsm"),
    ),
    (
        "nip44",
    ...
    (
        "nip36",
        include_str!("../../../modules/std/nip36/0.1.0.nsm"),
    ),
    (
        "nip40",
        include_str!("../../../modules/std/nip40/0.1.0.nsm"),
    ),
    (
        "nip88",
        include_str!("../../../modules/std/nip88/0.1.0.nsm"),
    ),
    (
        "nip92",
        include_str!("../../../modules/std/nip92/0.1.0.nsm"),
    ),
    (
        "nip27",
        include_str!("../../../modules/std/nip27/0.1.0.nsm"),
    ),
    (
        "nip30",
        include_str!("../../../modules/std/nip30/0.1.0.nsm"),
    ),
    (
        "nip39",
        include_str!("../../../modules/std/nip39/0.1.0.nsm"),
    ),
    (
        "nip73",
        include_str!("../../../modules/std/nip73/0.1.0.nsm"),
    ),
    (
        "nip35",
        include_str!("../../../modules/std/nip35/0.1.0.nsm"),
    ),
    (
        "nip99",
        include_str!("../../../modules/std/nip99/0.1.0.nsm"),
    ),
    (
        "nipb0",
        include_str!("../../../modules/std/nipb0/0.1.0.nsm"),
    ),
    (
        "nipc0",
        include_str!("../../../modules/std/nipc0/0.1.0.nsm"),
    ),
    (
        "nip34",
        include_str!("../../../modules/std/nip34/0.1.0.nsm"),
    ),
    (
        "nip54",
        include_str!("../../../modules/std/nip54/0.1.0.nsm"),
    ),
    (
        "nip72",
        include_str!("../../../modules/std/nip72/0.1.0.nsm"),
    ),
    (
        "nipc7",
        include_str!("../../../modules/std/nipc7/0.1.0.nsm"),
    ),
    (
        "nip64",
        include_str!("../../../modules/std/nip64/0.1.0.nsm"),
    ),
    (
        "nip7d",
        include_str!("../../../modules/std/nip7d/0.1.0.nsm"),
    ),
    (
        "nipf4",
        include_str!("../../../modules/std/nipf4/0.1.0.nsm"),
    ),
    (
        "nipcc",
    ...
    (
        "nip03",
        include_str!("../../../modules/std/nip03/0.1.0.nsm"),
    ),
    (
        "nip70",
        include_str!("../../../modules/std/nip70/0.1.0.nsm"),
    ),
    (
        "nip90",
        include_str!("../../../modules/std/nip90/0.1.0.nsm"),
    ),
    (
        "nipa0",
        include_str!("../../../modules/std/nipa0/0.1.0.nsm"),
    ),
    (
        "nip14",
        include_str!("../../../modules/std/nip14/0.1.0.nsm"),
    ),
    (
        "nip26",
        include_str!("../../../modules/std/nip26/0.1.0.nsm"),
    ),
    (
        "nip48",
        include_str!("../../../modules/std/nip48/0.1.0.nsm"),
    ),
    (
        "nip69",
        include_str!("../../../modules/std/nip69/0.1.0.nsm"),
    ),
    (
        "nip05",
        include_str!("../../../modules/std/nip05/0.1.0.nsm"),
    ),
    (
        "nip96",
        include_str!("../../../modules/std/nip96/0.1.0.nsm"),
    ),
    (
        "nip87",
        include_str!("../../../modules/std/nip87/0.1.0.nsm"),
    ),
    (
        "nipa3",
        include_str!("../../../modules/std/nipa3/0.1.0.nsm"),
    ),
];
...
mod tests {
    ...
    fn discovers_standard_layout() {
        ...
        let mut registry = ModuleRegistry::default();
        assert_eq!(registry.load_root(&root).unwrap(), 86);
    }
